...
export class CustomerTransfersService {
   ...
   */
  execute(data: EjecutarTransferenciaRequest): Observable<Result> {
   ...
   */
  getTransferById(id: number): Observable<Result> {
   ...
   */
  getMyTransfers(): Observable<Result> {
