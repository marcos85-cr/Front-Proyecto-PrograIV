...
export class CustomerPaymentsService {
  private readonly baseUrl = environment.apiUrl + '/pagosServicios';
   ...
   */
  getProviders(): Observable<Result> {
   ...
   */
  validateContract(data: ValidarContratoRequest): Observable<Result> {
   ...
   */
  makePayment(data: RealizarPagoRequest): Observable<Result> {
   ...
   */
  schedulePayment(data: ProgramarPagoRequest): Observable<Result> {
   ...
   */
  getPaymentById(id: number): Observable<Result> {
   ...
   */
  getMyPayments(): Observable<Result> {
