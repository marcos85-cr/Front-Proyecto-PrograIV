...
export class BeneficiariosService {
   ...
   */
  crear(data: CrearBeneficiarioRequest): Observable<Result> {
   ...
   */
  confirmar(id: number, codigo?: string): Observable<Result> {
   ...
   */
  getMisBeneficiarios(): Observable<Result> {
   ...
   * @param id - ID del beneficiario
   */
  getBeneficiarioById(id: number): Observable<Result> {
   ...
   */
  actualizar(id: number, data: ActualizarBeneficiarioRequest): Observable<Result> {
    const url = `${this.baseUrl}/${id}`;
   ...
   * @param id - ID del beneficiario
   */
  eliminar(id: number): Observable<Result> {
    const url = `${this.baseUrl}/${id}`;
